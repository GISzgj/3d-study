...
const shaderMaterial = new THREE.RawShaderMaterial({
  ...
  fragmentShader: `
    ...
    varying float vTime;
    void main() {
      float strength = 1.0/distance(vec2(vUv.x, vUv.y * 5.0), vec2(0.5,2.5)) /10.0;
      strength +=  1.0/distance(vec2(vUv.y,vUv.x *5.0), vec2(0.5,0.5 *5.0)) /10.0;
      // strength +=  1.0/distance(vec2(vUv.x *5.0,vUv.y), vec2(0.5*5.0,0.5)) /10.0;
