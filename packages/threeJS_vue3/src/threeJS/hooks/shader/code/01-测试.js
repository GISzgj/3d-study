...
const shaderMaterial = new THREE.RawShaderMaterial({
  ...
  vertexShader: `
    ...
    void main() {
      VTime = uTime;
      vUv = uv;
      // vec3 gposition = vec3(position.x + uTime, position.y, position.z);
      vec4 modelPosition = modelMatrix * vec4(position, 1.0);
      modelPosition.z = modelPosition.z * ((sin(uTime) + 1.0) * 0.5 +0.05);
      modelPosition.y = modelPosition.y * ((sin(uTime) + 1.0) * 0.5 +0.05);
      modelPosition.x = modelPosition.x * ((sin(uTime) + 1.0) * 0.5 +0.05);
